      ...
      <div className="flex-1 flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center justify-end gap-[36px] text-sm text-primary-900 sm:flex">
          <div className="flex flex-row items-start justify-start gap-[30px] lg:hidden">
            <a href="/" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              HOME
            </a>
            <a href="/about" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              ABOUT US
            </a>
            <a href="/agents" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              OUR AGENTS
            </a>
            <a href="/properties" className="[text-decoration:none] relative leading-[22px] font-semibold text-[inherit]">
              PROPERTIES
            </a>
            <a href="/gallery" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              GALLERY
            </a>
            <a href="/blog" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              BLOG
            </a>
            <a href="/contact" className="[text-decoration:none] relative leading-[22px] text-[inherit]">
              CONTACT US
            </a>
